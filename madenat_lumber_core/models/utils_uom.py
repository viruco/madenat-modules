...
# TD-009: Centralizado desde madenat_guia_processing.py (2026-06-04)
# Mapeo de dimensiones estándar de madera aserrada (espesor y ancho en mm)
# → thickness: espesor nominal en mm → texto visual en fracciones de pulgada
# → width: ancho nominal en mm → texto visual en pulgadas
# Fuente de verdad para compute en MadenatGuiaProcessingLine
# TD-010 migrará esto a modelos ORM configurables desde UI
# ==========================================================================
