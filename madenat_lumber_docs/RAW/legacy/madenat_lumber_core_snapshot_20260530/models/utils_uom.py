...
# ⚠️ DEPRECATED: Factor antiguo (usaba pies en lugar de metros)
# Mantenido por compatibilidad temporal, NO USAR en nuevos cálculos
IMPERIAL_TO_M3_FACTOR_DEPRECATED = Decimal('5085.312')  # in² × pies → m³
