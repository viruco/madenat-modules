...
4. Evaluar si corresponde eliminar o marcar como deprecated el campo `lumber_reception_id` en una fase futura.
...
*Versión: 1.1.0 — Corregido: `reception_id` establecido como campo canónico operativo; `lumber_reception_id` catalogado como legacy/huérfano.*