...
**Responsable revisión:** 2026-09-12 — Sincronización de versiones/fechas de los documentos canónicos (00=7.7.0, 02=12.2.0, 04=12.2.0, 08=1.6.0, 12=1.3.0, 13=1.6.0).
...
|---|---|---|---|---|
| `00_ARQUITECTURA.md` | Arquitectura, modelos, gates, campos, restricciones | 7.7.0 | 2026-09-12 | ✅ Vigente |
...
| `08_COSTEO.md` | Flujo canónico de costeo end-to-end | 1.6.0 | 2026-09-12 | ✅ Vigente |
...
| `12_FLUJOS_INGESTA.md` | Flujos de ingesta de madera y discriminación operativa | 1.3.0 | 2026-09-12 | ✅ Vigente |
...
| `13_CONSOLIDACION_OPERATIVA.md` | Consolidación operativa: ingesta (Producto/Procesados), reglas, trazabilidad, matriz de hallazgos y contradicciones | 1.6.0 | 2026-08-23 | ✅ Vigente |
| `INDICE_DOCUMENTACION.md` | Este archivo. Mapa maestro | 11.0.0 | 2026-09-12 | ✅ Vigente |
